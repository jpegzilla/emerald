...
0;f<e.length;f++){var n=e[f];if(c!==c&&n.key!==n.key||c===n.key)return{id:d,list:e,index:f,entry:n}}return{id:d,list:e,index:-1,entry:void 0}},f=function(a,c){var b=a.head_;return $jscomp.iteratorPrototype(function(){if(b){for(;b.head!=a.head_;)b=b.previous;for(;b.next!=b.head;)return b=b.next,{done:!1,value:c(b)};b=null}return{done:!0,value:void 0}})},e=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
colorGenerationCount=document.getElementById("color-generation-count"),colorPaletteGenerationSlider=document.getElementById("generation-count-slider"),colorFactorCount=document.getElementById("color-generation-factor-count"),colorSeperationFactorSlider=document.getElementById("color-generation-factor"),colorPaletteCount=5,colorSeperationFactor=10,paletteGenParams={setting:paletteGenerationSettings.children[0].innerText,count:colorPaletteCount,factor:colorSeperationFactor},BODY=document.body,urlParams=
geturlvars();disableScroll();
window.onload=function(){setComputedColors(!0);preloader=document.getElementById("preloader");preloader.classList.add("hidden");BODY.classList.add("scroll");enableScroll();var a={red:document.getElementById("rInput"),green:document.getElementById("gInput"),blue:document.getElementById("bInput")},b={red:document.getElementById("trInput"),green:document.getElementById("tgInput"),blue:document.getElementById("tbInput")},c=document.getElementById("hex-code"),d=function(){try{var a=hexToRGBA(c.value),
b="rgb("+a.r+", "+a.g+", "+a.b+")";return"background"==currentColorSetting?f(b):e(b)}catch(g){}};c.addEventListener("change",function(){return d()});c.addEventListener("input",function(){var a=c.value.search(/[^A-Fa-f0-9|^#]/gi);c.value=c.value.replace(/\s/,"");-1!=a&&(c.value=c.value.substring(0,a)+"0"+c.value.substring(a+1),d());0!=c.value.indexOf("#")&&(c.value="#");-1!=c.value.indexOf("#",1)&&0!=c.value.indexOf("#",1)&&(c.value="#"+c.value.substring(1).replace(/#/gim,"0"),d());7==c.value.length&&
d()});a.red.value=defbgRGB.r;a.green.value=defbgRGB.g;a.blue.value=defbgRGB.b;b.red.value=deftxtRGB.r;b.green.value=deftxtRGB.g;b.blue.value=deftxtRGB.b;var f=function(a,b){b=void 0===b?!0:b;colorDisplay.style.backgroundColor=a;bgColorPreview.style.backgroundColor=a;bgColorAltPreview.style.backgroundColor=a;bgSliders.forEach(function(b){return b.style.color=a});1==b&&setComputedColors()},e=function(a,b){b=void 0===b?!0:b;colorName.style.color=a;contrastRatioDisplay.style.color=a;colorPicker.style.color=
a;textColorPreview.style.backgroundColor=a;textColorAltPreview.style.backgroundColor=a;addToPalette.style.color=a;openSettings.style.color=a;txtSliders.forEach(function(b){return b.style.color=a});1==b&&setComputedColors()},k="fail",n="aaa",u=function(a){var b=a.start;a=a.end;b||a||(k="fail",n="aaa");b&&(k=b);a&&(n=a)};u({start:null,end:null});var m=function(){contrastRatiosSet=!0;var a=randomParamsStart.value,b=randomParamsEnd.value,c=["fail","aa large","aa","aaa"];if(c.indexOf(a)>c.indexOf(b)){var d=
b;randomParamsStart.value=c[c.indexOf(d)];randomParamsEnd.value=c[c.indexOf(a)];b=a;a=d}u({start:a,end:b})};randomParamsStart.addEventListener("input",m);randomParamsEnd.addEventListener("input",m);m=function(){var a=colorPaletteGenerationSwitch.value,b=parseInt(colorPaletteGenerationSlider.value),c=parseInt(colorSeperationFactorSlider.value);colorGenerationCount.textContent=b;colorFactorCount.textContent=c;paletteGenParams={setting:a,count:b,factor:c}};colorPaletteGenerationSwitch.addEventListener("input",
m);colorPaletteGenerationSlider.addEventListener("input",m);colorSeperationFactorSlider.addEventListener("input",m);void 0!=STORAGE.getItem("darkMode")&&"false"==STORAGE.getItem("darkMode")?(globalTheme="light",themeSelect.selectedIndex=1,BODY.classList.remove("dark")):(globalTheme="dark",themeSelect.selectedIndex=0,BODY.classList.add("dark"));themeSelect.addEventListener("input",function(){"dark"==themeSelect.value&&0==BODY.classList.contains("dark")&&BODY.classList.add("dark");"light"==themeSelect.value&&
1==BODY.classList.contains("dark")&&BODY.classList.remove("dark");BODY.classList.contains("dark")?STORAGE.setItem("darkMode","true"):STORAGE.setItem("darkMode","false")});var v=function(){for(var a="#",b=0;6>b;b++)a+="0123456789ABCDEF"[Math.floor(16*Math.random())];return a},r=function(){if(bgLocked&&textLocked)return!1;0<colorHistory.length&&1==initialRandomize&&(initialRandomize=!1,Array.from(document.getElementsByClassName("control-button")).forEach(function(a){return a.classList.remove("disabled")}));
var c=!0===bgLocked?colorObject.bg.hex:v(),d=!0===textLocked?colorObject.text.hex:v(),g=hexToRGBA(c),l=hexToRGBA(d),h="rgb("+g.r+", "+g.g+", "+g.b+")",w="rgb("+l.r+", "+l.g+", "+l.b+")";a.red.value=g.r;a.green.value=g.g;a.blue.value=g.b;b.red.value=l.r;b.green.value=l.g;b.blue.value=l.b;if(1==contrastRatiosSet){var c=getContrastRatio(c,d).number,d=[k,n],m=["fail","aa large","aa","aaa"],q;for(q in wcagLevels)for(var p in wcagLevels[q])if(g=wcagLevels[q][p],c>=g[0]&&c<=g[1])if(l=[].concat($jscomp.arrayFromIterable(m)),
d=Array.from(new Set([].concat($jscomp.arrayFromIterable(d)))),g=l.indexOf(d[0]),l=-1!==l.indexOf(d[1])?l.indexOf(d[1]):g,g=function(a,b){return Array(b-a+1).fill(void 0).map(function(b,c){return c+a})}(g,l).map(function(a){return m[a]}),q=q.toLowerCase(),0==g.includes(q))try{r()}catch(B){throw CURRENT_ERR="there is no acceptable color combination for the current settings. please modify contrast ratio limit.",new RangeError(CURRENT_ERR);}else if(g.includes(q)){f(h,!1);e(w,!1);setComputedColors(!0);
break}}else f(h,!1),e(w,!1),setComputedColors(!0)};BODY.onkeydown=function(a){32==a.keyCode&&document.activeElement==BODY&&a.preventDefault()};BODY.onkeyup=function(a){if(32==a.keyCode&&document.activeElement==BODY){a.preventDefault();if(document.getElementById("randomizeReminder")){var b=document.getElementById("randomizeReminder");b.classList.add("hidden");setTimeout(function(){return b.remove()},300)}r()}};document.getElementById("randomize-mobile").addEventListener("click",function(){return r()});
for(var p in a)a.hasOwnProperty(p)&&a[p].addEventListener("input",function(){f("rgb("+a.red.value+", "+a.green.value+", "+a.blue.value+")")});for(var h in b)b.hasOwnProperty(h)&&b[h].addEventListener("input",function(){e("rgb("+b.red.value+", "+b.green.value+", "+b.blue.value+")")});swapColors.addEventListener("click",function(){a.red.value=colorObject.text.rgb.r;a.green.value=colorObject.text.rgb.g;a.blue.value=colorObject.text.rgb.b;b.red.value=colorObject.bg.rgb.r;b.green.value=colorObject.bg.rgb.g;
b.blue.value=colorObject.bg.rgb.b;var c="rgb("+b.red.value+", "+b.green.value+", "+b.blue.value+")";f("rgb("+a.red.value+", "+a.green.value+", "+a.blue.value+")",!1);e(c,!1);setComputedColors(!1)});document.addEventListener("scroll",function(){var a=document.getElementById("color-controls"),b=document.getElementById("header"),c=function(){if("undefined"!=typeof pageYOffset)return pageYOffset;var a=BODY,b=document.documentElement,b=b.clientHeight?b:a;return b.scrollTop},d=document.getElementsByClassName("alt-color-display")[0];
c()>a.offsetTop-100?(b.classList.add("invert"),d.classList.remove("hidden")):c()<a.offsetTop-100&&b.classList.contains("invert")&&(b.classList.remove("invert"),d.classList.add("hidden"))});var t,x=window.localStorage,A=function(){t.prompt()["catch"](function(a){return console.log(a.message)});t.userChoice.then(function(a){"accepted"===a.outcome?x.setItem("installed",!0):x.setItem("installed",!1);t=null})["catch"](function(a){return console.log(a)})};window.addEventListener("beforeinstallprompt",function(a){t=
a;document.getElementById("pwaInstallButton").addEventListener("click",function(){A()})});var y=function(c){if(void 0!==colorHistory[colorHistoryIndex+c]){colorHistoryIndex+=c;colorHistoryIndex=0>colorHistoryIndex?0:colorHistoryIndex>colorHistory.length-1?colorHistory.length-1:colorHistoryIndex;var d=hexToRGBA(colorHistory[colorHistoryIndex].bg.hex);c=hexToRGBA(colorHistory[colorHistoryIndex].text.hex);d="rgb("+d.r+", "+d.g+", "+d.b+")";c="rgb("+c.r+", "+c.g+", "+c.b+")";a.red.value=colorObject.bg.rgb.r;
a.green.value=colorObject.bg.rgb.g;a.blue.value=colorObject.bg.rgb.b;b.red.value=colorObject.text.rgb.r;b.green.value=colorObject.text.rgb.g;b.blue.value=colorObject.text.rgb.b;f(d,!1);e(c,!1);setComputedColors(!1)}void 0==colorHistory[colorHistoryIndex+1]?redo.classList.add("disabled"):redo.classList.remove("disabled");void 0==colorHistory[colorHistoryIndex-1]?undo.classList.add("disabled"):undo.classList.remove("disabled")};undo.addEventListener("click",function(){y(-1)});redo.addEventListener("click",
function(){y(1)});var z=function(c){var d;"\ud83d\udd13"==c.innerHTML?(d=!0,c.innerHTML="&#x1F512;"):(d=!1,c.innerHTML="&#x1F513;");c==lockBg?1==d?bgLocked=!0:bgLocked=!1:1==d?textLocked=!0:textLocked=!1;if(1==bgLocked)for(var e in a)a[e].disabled=!0;if(0==bgLocked)for(var f in a)a[f].disabled=!1;if(1==textLocked)for(var h in b)b[h].disabled=!0;if(0==textLocked)for(var k in b)b[k].disabled=!1};lockBg.addEventListener("click",function(){return z(lockBg)});lockText.addEventListener("click",function(){return z(lockText)});
if(2==Object.entries(urlParams).length)console.log("[window] url parameters:",urlParams),h=urlParams.text,p=hexToRGBA(urlParams.bg),h=hexToRGBA(h),h="rgb("+h.r+", "+h.g+", "+h.b+")",f("rgb("+p.r+", "+p.g+", "+p.b+")",!1),e(h,!1),setComputedColors(!1);else if(2<Object.entries(urlParams).length)throw Error("please provide 2 hex colors in url like this: jpegzilla.com/emerald?bg=color1&text=color2.");};
