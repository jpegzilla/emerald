...
1==mobilecheck()?drawSwatchesMobile(a):drawSwatches(a):drawSwatches(a);switch(exportType){case "sass":exportTextContainer.children[0].classList.add("active");break;case "css":exportTextContainer.children[1].classList.add("active");break;case "image":exportTextContainer.children[2].classList.add("active")}},exportPalette=function(a,b,c){c=void 0===c?!0:c;console.log(b);c&&openExportModal();c=PALETTES[b];b=!1;0==FANCY_COLOR_NAMES&&(b=FANCY_COLOR_NAMES=!0,setColorNames());for(var d=[],e=0;e<c.length;e++)d.push({bg:findNearestColor(c[e].bg.hex),
...
b.id="";b.classList.add("palette-bar");b.classList.remove("empty");b.getElementsByClassName("palette-number")[0].textContent="palette "+paletteHumanIndex;var c=b.getElementsByClassName("palette-number")[0].textContent;paletteHumanIndex++;var d=b.getElementsByClassName("export-palette")[0],e=b.getElementsByClassName("remove-palette")[0],f={name:c,palette:b};paletteContainer.appendChild(b);var h=Array.from(paletteContainer.children).indexOf(b);e.addEventListener("click",function(){return paletteControls(b,
"remove",h)});d.addEventListener("click",function(){return paletteControls(f,"export",h)});a.forEach(function(a){var c=palettePigmentTemplate.cloneNode(!0);c.children[0].style.backgroundColor=a.bg.hex;c.children[1].style.backgroundColor=a.text.hex;c.children[0].textContent=a.bg.hex;c.children[1].textContent=a.text.hex;setPigmentTextColor(c);c.children[0].addEventListener("click",function(a){return copyContent(a,c.children[0])});c.children[1].addEventListener("click",function(a){return copyContent(a,
c.children[1])});c.id="";c.classList.add("palette-pigment");b.appendChild(c)})})};PALETTES&&0<PALETTES.length&&0!=PALETTES[0].length&&loadSavedPalettes();
